...
namespace SQLiteDotNet
{
    class Program
    {
        ...
        static void InsertData(SQLiteConnection conn)
        {
            ...
            sqlString = "INSERT INTO Customers(customer_id, name, surname, age) VALUES('cust2', 'Bob', 'Deere', 57); ";
            sqlite_cmd.CommandText = sqlString;
            sqlite_cmd.ExecuteNonQuery();

            sqlString = "INSERT INTO Customers(customer_id, name, surname, age) VALUES('cust3', 'John', 'Reer', 24); ";
            sqlite_cmd.CommandText = sqlString;
            sqlite_cmd.ExecuteNonQuery();
